// <copyright file="GameTag.cs" company="SpectralCoding.com">
...
namespace HSCSReader.Support.HSEnumerations {
	public enum GameTag {
		...
		PREDAMAGE = 318,
		// <jleclanche> ENCHANTMENT_BIRTH_VISUAL is negative/positive visual setting
